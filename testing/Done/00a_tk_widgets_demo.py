...
class App(tk.Tk):
    ...
    def setup_widgets(self, container):
        ...
        # Accentbutton
        accentbutton = ttk.Button(widgets_frame, text="Accent button", style="Accent.TButton")
        accentbutton.grid(row=7, column=0, padx=5, pady=10, sticky="nsew")

        # Togglebutton
        togglebutton = ttk.Checkbutton(widgets_frame, text="Toggle button", style="Toggle.TButton")
...
if __name__ == "__main__":
    ...
    main = App(title='test sun-valley')
    main.mainloop()
